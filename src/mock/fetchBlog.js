...
const reg = /^api\/blogForId\?.{1,500}$/;
export default Mock.mock(reg, {
  code: 0,
  msg: "",
  data: {
    id: "@guid",
    ...
    createDate: "@date('T')",
    toc: [
      { title: "概述", anchor: "article-md-title-1" },
      {
        title: "简单请求",
        ...
        children: {
          title: "",
          list: [
            { title: "简单请求的判定", anchor: "article-md-title-3" },
            { title: "简单请求的交互规范", anchor: "article-md-title-4" },
          ],
        },
      },
      {
